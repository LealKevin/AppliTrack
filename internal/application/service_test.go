...
Backend Developer,StartupInc,2024-01-16,New York,pending,Remote work,https://startup.com`,
			mockSetup: func(mockStore *MockStore) {
				mockStore.On("CreateOne", db.CreateOneApplicationParams{
					...
					Notes:            pgtype.Text{String: "Great opportunity", Valid: true},
				...
				mockStore.On("CreateOne", db.CreateOneApplicationParams{
					...
					Notes:            pgtype.Text{String: "Remote work", Valid: true},
					UrlApplication:   pgtype.Text{String: "https://startup.com", Valid: true},
				}).Return(db.Application{
					ID:               uuid.New(),
					TitleApplication: "Backend Developer",
					Company:          "StartupInc",
...
Frontend Developer,BigCorp,2024-01-17,Boston,rejected,Not selected,https://bigcorp.com`,
			mockSetup: func(mockStore *MockStore) {
				...
				mockStore.On("CreateOne", db.CreateOneApplicationParams{
					...
					Notes:            pgtype.Text{String: "Not selected", Valid: true},
					UrlApplication:   pgtype.Text{String: "https://bigcorp.com", Valid: true},
				}).Return(db.Application{
					ID:               uuid.New(),
					TitleApplication: "Frontend Developer",
					Company:          "BigCorp",
